...
font = ImageFont.truetype("arial.ttf",size=max_height/2)
img = Image.new('RGB', (total_width,max_height), (242, 242, 242))
d = ImageDraw.Draw(img)
font_width, font_height = font.getbbox(strTest)[-2:]
new_width = (total_width - font_width) / 2
new_height = (max_height - font_height) / 2
#text_width, text_height = d.textsize(strTest)
d.text((new_width, new_height), strTest, fill=(0,0,0), font=font)
img.save(strFolImage + '\\testText.jpg')
