...
$User32::SetWindowPos($CurrentProcess.MainWindowHandle, 0x0, 0, $intheight/2, $intwidth/1.97, $intheight/1.97, 0x0040 -bor 0x0020)
cd "C:\pierre\apps\python apps\server"
echo "positionning done"
cmd /c "color 0a"
echo "========Sending Result Messages To Middleware========"
py pTestTCPServer_v6.py
PowerShell
