...
$User32::SetWindowPos($CurrentProcess.MainWindowHandle, 0x0, $intwidth/2, $intheight/2, $intwidth/1.97, $intheight/1.97, 0x0040 -bor 0x0020)
cd "C:\pierre\apps\python apps"
echo "positionning done"
cmd /c "color 0a"
echo "========Capturing Messages From Instrument========"
py pTestTCPClientMoxaG8_v8.py
PowerShell
